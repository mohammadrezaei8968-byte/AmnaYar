# استقرار رایگان امنا یار — نسخه 5.11.0
...
## وضعیت داده
`INITIAL_CREDITS=0` در نسخه نهایی تنظیم شده است. ثبت‌نام رایگان است و استعلام فقط با اعتبار انجام می‌شود؛ کاربر باید اعتبار را از بسته‌های موجود خریداری کند.
